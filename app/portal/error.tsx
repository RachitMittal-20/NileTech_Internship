...
// Renders inside app/portal/layout.tsx's shell (sidebar + header stay
// usable) when a page under /portal throws.
    ...
    <div className="flex flex-1 flex-col items-center justify-center gap-6 px-6 py-16 text-center">
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="max-w-sm text-sm text-muted-foreground">
          Something went wrong loading this section. Try again, or head back to your dashboard.
        </p>
      </div>
